...
_C.MODEL.VIM = CN()
_C.MODEL.VIM.PATCH_SIZE = 16
_C.MODEL.VIM.IN_CHANS = 3
_C.MODEL.VIM.EMBED_DIM = 768
_C.MODEL.VIM.DEPTH = 24
_C.MODEL.VIM.D_STATE = 16
_C.MODEL.VIM.D_CONV = 4
_C.MODEL.VIM.EXPAND = 2
_C.MODEL.VIM.DT_RANK = 'auto'
_C.MODEL.VIM.USE_MIDDLE_CLS_TOKEN = True
_C.MODEL.VIM.BIMAMBA_TYPE = 'v2'
_C.MODEL.VIM.RMS_NORM = True
